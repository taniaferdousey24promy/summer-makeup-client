      ...
      >
        <SwiperSlide>
          ...
          <div className="   -mt-[600px] text-left   ml-40">
            ...
            <h3 className=" font text-2xl text-pink-800 mt-4 mb-20 mt-16">
              signup by 6-28, 2023
            </h3>
          </div>
        </SwiperSlide>
        ...
        <SwiperSlide className=" brightness-75">
          <img
            className=" h-[700px] w-[2000px] me-40"
            src="https://i.postimg.cc/xCGYN5kp/28448742259-bc865057b1-b.jpg"
            alt=""
          />
          ...
          <div className="m-4 absolute bottom-10 left-20 right-30 top-10 px-4 py-2 bg-gray-800 opacity-70">
            <div className=" mt-8 mx-8 font uppercase  text-white mb-8 font-bold">
              ...
              <p className=" mt-12 lowercase">Makeup-classes | www.youwhere.com</p>
              <p className="lowercase">Free makeup classes flyer template from EDIT.org</p>
            </div>
            {/* 
            <h1 className="mt-12">Content</h1>
            <ol type="1">
            ...
            {/* <h3 className=" font uppercase text-5xl text-white font-bold mb-8 ">
              Summer Camp
            </h3>
